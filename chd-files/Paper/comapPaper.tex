...
%	\begin{tabular}{lll}
%		\toprule
%		\rowcolor[rgb]{ .886,  .937,  .855} aaa   & ddd   & hhh \\
%		\midrule
%		bbb   & eee   & aaa \\
%		\rowcolor[rgb]{ .949,  .949,  .949} ccc   & fff   & bbb \\
%		ddd   & ggg   & ccc \\
%		\rowcolor[rgb]{ .949,  .949,  .949} eee   & aaa   & ddd \\
%		fff   & bbb   & eee \\
%		\rowcolor[rgb]{ .949,  .949,  .949} ggg   & ccc   & fff \\
%		hhh   & ddd   & ggg \\
%		\bottomrule
%	\end{tabular}%
%	\label{tab:addlabel}%
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{fig/LSTM}
	\caption{Detailed diagram of LSTM}
	\label{fig:lstm_flow}
\end{figure}
